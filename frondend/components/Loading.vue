<template>
  <div class="text-center">
    <div class="figures">
      <svg
        class="figures__animation"
        viewBox="0 0 512 512"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path fill="#f4f6f9" fill-opacity="0" d="M0 0h512v512H0z"></path>
        <text transform="translate(97.173 475.104)"></text>
        <path
          d="M307.2 224.6c0 4.6-.5 9-1.6 13.2-2.5-4.4-5.6-8.4-9.2-12-4.6-4.6-10-8.4-16-11.2 2.8-11.2 4.5-22.9 5-34.6 1.8 1.4 3.5 2.9 5 4.5 10.5 10.3 16.8 24.5 16.8 40.1zM232.2 214.6c-6 2.8-11.4 6.6-16 11.2-3.5 3.6-6.6 7.6-9.1 12-1-4.3-1.6-8.7-1.6-13.2 0-15.7 6.3-29.9 16.6-40.1 1.6-1.6 3.3-3.1 5.1-4.5.6 11.8 2.2 23.4 5 34.6z"
          fill="#2E3B39"
        ></path>
        <path
          class="body"
          d="M279.7 217.6c12.9-48.1 5.1-104-23.4-142.6-28.5 38.5-36.2 94.5-23.4 142.6h46.8z"
          fill="#FF7058"
        ></path>
        <path
          class="tip"
          d="M273 104.7c-4.4-10.6-9.9-20.6-16.6-29.7-6.7 9-12.2 19-16.6 29.7H273z"
          fill="#2E3B39"
        ></path>
        ...
        <path
          class="removehole"
          d="M267.5 139.9l-16 16c4.5 2 9.8 1.1 13.5-2.5 3.6-3.7 4.5-9.1 2.5-13.5z"
          fill="#54C0EB"
        ></path>
        <path
          class="fuel"
...
.smoke {
  -webkit-animation: smoke 0.1s infinite ease-in-out alternate;
  animation: smoke 0.1s infinite ease-in-out alternate;
  -webkit-transform-origin: center;
  transform-origin: center;
  opacity: 0.8;
}
@-moz-document url-prefix() {
  .smoke {
    animation: smokeFirefox 0.2s infinite ease-in-out alternate;
  }
}
...
.flame {
  -webkit-animation: burnInner2 0.1s infinite ease-in-out alternate;
  animation: burnInner2 0.1s infinite ease-in-out alternate;
}
@-webkit-keyframes burnInner2 {
  ...
  100% {
    -webkit-transform: translate(265px, 253px) scale(2.2) rotate(180deg)
      skew(-5deg);
